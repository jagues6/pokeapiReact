...
export const FirsApp = () => {
    ...
    const [imgPokemon, setImgPokemon] = useState({ img: '', stats: [], types: [], name: "", tiposDanio: [] })
        ...
        <div>
            ...
            <div id="hijo">
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
                    <div style={{ display: 'flex', flexDirection: 'column', borderRadius: "20px", alignItems: 'center', backgroundColor: colores[imgPokemon.types[0]?.type.name] }}>
                        <h1>{imgPokemon.name.charAt(0).toUpperCase() + imgPokemon.name.slice(1)}</h1>
                    ...
                    <div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            <h1 style={{ margin: "0", marginBottom: "20px" }}>Tipos del pokemon</h1>
                            <div style={{ display: "grid", gridTemplateColumns: `repeat(${imgPokemon.types?.length > 1 ? 3 : 1}, 1fr)`, gap: "10px", justifyContent: 'center' }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            <h1 style={{ margin: "0", marginBottom: "20px", marginTop: "10px" }}>Debilidades del pokemon</h1>
                            <div style={{ display: "grid", gridTemplateColumns: `repeat(${imgPokemon.tiposDanio?.length > 1 ? 3 : 1}, 1fr)`, gap: "10px", justifyContent: 'center', alignItems:"center" }}>
                                {
